...
{[CorpseName( "Barbara's Corpse" )]public class Barbara : Mobile{public virtual bool IsInvulnerable{ get{ return true; } }
[Constructable]public Barbara(){
...
///////////title
Title = "Bar Wench of Festival Wine [?]";
...
public Barbara( Serial serial ) : base( serial ){}
public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
{ base.GetContextMenuEntries( from, list ); list.Add( new BarbaraEntry( from, this ) ); } 
public override void Serialize( GenericWriter writer ){base.Serialize( writer );writer.Write( (int) 0 );}
public override void Deserialize( GenericReader reader ){base.Deserialize( reader );int version = reader.ReadInt();}
public class BarbaraEntry : ContextMenuEntry{private Mobile m_Mobile;private Mobile m_Giver;
public BarbaraEntry( Mobile from, Mobile giver ) : base( 6146, 3 ){m_Mobile = from;m_Giver = giver;}
public override void OnClick(){if( !( m_Mobile is PlayerMobile ) )return;
PlayerMobile mobile = (PlayerMobile) m_Mobile;{

///////////gump name
if ( ! mobile.HasGump( typeof( BarbaraQuestGump ) ) ){
mobile.SendGump( new BarbaraQuestGump( mobile ));}}}}
public override bool OnDragDrop( Mobile from, Item dropped ){               Mobile m = from;PlayerMobile mobile = m as PlayerMobile;
if ( mobile != null){

///////////item to be dropped
if( dropped is FestivalWine ){if(dropped.Amount!=1)
...
///////////thanks message
this.PrivateOverheadMessage( MessageType.Regular, 1153, false, "Thank you!  I will add this to our reserves right away!", mobile.NetState );
