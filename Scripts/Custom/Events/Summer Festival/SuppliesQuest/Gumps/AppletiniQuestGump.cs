...
{ public class AppletiniQuestGump : Gump { 
public static void Initialize() { 
CommandSystem.Register( "AppletiniQuestGump", AccessLevel.GameMaster, new CommandEventHandler( AppletiniQuestGump_OnCommand ) ); 
}
private static void AppletiniQuestGump_OnCommand( CommandEventArgs e ) 
{
e.Mobile.SendGump( new AppletiniQuestGump( e.Mobile ) ); } 
public AppletiniQuestGump( Mobile owner ) : base( 50,50 ) 
{
//----------------------------------------------------------------------------------------------------
AddPage( 0 );AddImageTiled(  54, 33, 369, 400, 2624 );AddAlphaRegion( 54, 33, 369, 400 );AddImageTiled( 416, 39, 44, 389, 203 );
//--------------------------------------Window size bar--------------------------------------------
AddImage( 97, 49, 9005 );AddImageTiled( 58, 39, 29, 390, 10460 );AddImageTiled( 412, 37, 31, 389, 10460 );
AddLabel( 140, 60, 0x34, "Summer Festival Provisions" );
//----------------------/----------------------------------------------/
AddHtml( 107, 140, 300, 230, " < BODY > " + 
"<BASEFONT COLOR=YELLOW>Hail and well met adventurer! <BR>" +
"<BASEFONT COLOR=YELLOW>Our village is running low on it's food supplies for the Summer Festival.<BR>" +
"<BASEFONT COLOR=YELLOW>Have you brought me some Provisions!??.<BR>" +
"<BASEFONT COLOR=YELLOW>If you bring me more, I will reward you!<BR>" +
