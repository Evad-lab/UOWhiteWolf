...
namespace Server.Mobiles
{
    ...
    public class CorruptedWaterSpirit : BaseRenowned
    {
        [Constructable]
        public CorruptedWaterSpirit()
            : base(AIType.AI_Mystic)
        {
            this.Name = "a Corrupted Water Droplet Spirit";
            this.BodyValue = 265;
        ...
        public CorruptedWaterSpirit(Serial serial)
            : base(serial)
        {
        }
