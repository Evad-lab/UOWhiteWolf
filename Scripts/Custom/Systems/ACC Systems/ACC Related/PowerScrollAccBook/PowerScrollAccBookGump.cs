...
namespace Server.Items
{
    public class PowerScrollBookGump : Gump
    {
        ...
        private PowerScrollBookAcc m_Book;
        ...
        public PowerScrollBookGump(PlayerMobile from, PowerScrollBookAcc book)
        ...
        private class SetPricePrompt : Prompt
        {
            ...
            public SetPricePrompt(PowerScrollBookAcc book, object obj, int page, ArrayList list)
            {
                m_Book = book;
                m_Object = obj;
                m_Page = page;
        ...
        public PowerScrollBookGump(PlayerMobile from, PowerScrollBookAcc book, int page, ArrayList list)
            : base(12, 24)
        {
