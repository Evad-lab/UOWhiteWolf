...
{
    public class PowerScrollBookAcc : Item, ISecurable
    {
        ...
        public PowerScrollBookAcc(Serial serial)
            : base(serial)
        {
        }
        ...
        private class NameBookEntry : ContextMenuEntry
        {
            ...
            public NameBookEntry(Mobile from, PowerScrollBookAcc book)
                : base(6216)
            {
                m_From = from;
                m_Book = book;
        ...
        private class NameBookPrompt : Prompt
        {
            ...
            public NameBookPrompt(PowerScrollBookAcc book)
            {
                m_Book = book;
            }
