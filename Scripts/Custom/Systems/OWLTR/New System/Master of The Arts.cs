...
namespace Server.Mobiles
{
	...
	public class MasterOfTheArts : BaseCreature //make it use the creature files/settings
	{
		...
		[Constructable]
		public MasterOfTheArts() : this ( true )
		{
		}
		...
		{
			PsCount = ChampionSpawn ? (Utility.Random( 3 ) + 1) : 1; //set how many ps to give if it spawned using champ spawn or normal spawn

			for ( int i = 0; i < PsCount; ++i ) 
			{
				Mobile killer = this.FindMostRecentDamager(false);
				...
				{		
					PlayerMobile m = (PlayerMobile)killer;	
					...
					{ 
						...
						case 13: m.AddToBackpack( new PowerScroll( SkillName.ArmsLore, level ) ); break;
					}
					...
					{
						switch ( Utility.Random( 58 )) //select random number between 0-46
						{
							...
							case 47: m.AddToBackpack( new RunicDovetailSaw( CraftResource.Heartwood, 10 ) ); break;
							case 48: m.AddToBackpack( new RunicDovetailSaw( CraftResource.Bloodwood, 10 ) ); break;
							case 49: m.AddToBackpack( new RunicDovetailSaw( CraftResource.Frostwood, 10 ) ); break;
							case 50: m.AddToBackpack( new RunicDovetailSaw( CraftResource.OakWood, 10 ) ); break;
							case 51: m.AddToBackpack( new RunicDovetailSaw( CraftResource.AshWood, 10 ) ); break;
							case 52: m.AddToBackpack( new RunicDovetailSaw( CraftResource.YewWood, 10 ) ); break;
							case 53: m.AddToBackpack( new RunicDovetailSaw( CraftResource.Ebony, 10 ) ); break;
							case 54: m.AddToBackpack( new RunicDovetailSaw( CraftResource.Bamboo, 10 ) ); break;
							case 55: m.AddToBackpack( new RunicDovetailSaw( CraftResource.PurpleHeart, 10 ) ); break;
							case 56: m.AddToBackpack( new RunicDovetailSaw( CraftResource.Redwood, 10 ) ); break;
							case 57: m.AddToBackpack( new RunicDovetailSaw( CraftResource.Petrified, 10 ) ); break;
