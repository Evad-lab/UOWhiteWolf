...
{
	[CorpseName( "a guardian Ferret corpse" )]
	public class GuardianFerret : Ferret, IEvoGuardian
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

		[Constructable]
		public GuardianFerret() : base( "A Guardian Fairy Dragon" )
		{
		}

		public GuardianFerret( Serial serial ) : base( serial )
		{
		}
