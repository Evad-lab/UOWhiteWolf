...
namespace Xanthos.Evo
{
	public class MercenarySpec : BaseEvoSpec
	{
		...
		MercenarySpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new MercenaryStageZero(), new MercenaryStageOne(), new MercenaryStageTwo(),
											...
											new MercenaryStageSix(), new MercenaryStageSeven() };
		}
	...
	public class MercenaryStageOne : BaseEvoStage
	{
		public MercenaryStageOne()
		{
			...
			EvolutionMessage = "has attained a new level of combat";
			NextEpThreshold = 250000; EpMinDivisor = 20; EpMaxDivisor = 10;
	...
	public class MercenaryStageFive : BaseEvoStage
	{
		public MercenaryStageFive()
		{
			...
			ControlSlots = 3; VirtualArmor = 40;
	...
	public class MercenaryStageSix : BaseEvoStage
	{
		public MercenaryStageSix()
		{
			...
			NextEpThreshold = 150000000; EpMinDivisor = 800; EpMaxDivisor = 700;
			ControlSlots = 4; VirtualArmor = 45;
	...
	public class MercenaryStageSeven : BaseEvoStage
	{
		...
		{
			Title = "The Ancient Mercenary";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Mercenary";
			NextEpThreshold = 0; EpMinDivisor = 840; EpMaxDivisor = 860;
			ControlSlots = 4; VirtualArmor = 50;
		
			DamageMin = 5; DamageMax = 10; HitsMin= 125; HitsMax = 200;
			StrMin = 75; StrMax = 90; DexMin = 75; DexMax = 90; IntMin = 20; IntMax = 50;
		}
	}
}