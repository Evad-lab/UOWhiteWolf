...
{
	public sealed class FairyDragonSpec : BaseEvoSpec
	{
		...
		FairyDragonSpec()
		{
			...
			m_Stages = new BaseEvoStage[] { new FairyDragonStageOne(), new FairyDragonStageTwo(),
											  new FairyDragonStageThree(), new FairyDragonStageFour(),
											  new FairyDragonStageFive(), new FairyDragonStageSix(),
											  new FairyDragonStageSeven() };
		}
		...
		public static FairyDragonSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly FairyDragonSpec instance = new FairyDragonSpec();}
	}	
	...
	public class FairyDragonStageOne : BaseEvoStage
	{
		public FairyDragonStageOne()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 75000; EpMinDivisor = 10; EpMaxDivisor = 5; DustMultiplier = 20;
			BaseSoundID = 0x266;
			BodyValue = 81; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 30;
	...
	public class FairyDragonStageTwo : BaseEvoStage
	{
		public FairyDragonStageTwo()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 150000; EpMinDivisor = 20; EpMaxDivisor = 10; DustMultiplier = 20;
			BaseSoundID = 0x26B;
			BodyValue = 80; VirtualArmor = 40;
            ControlSlots = 3;
	...
	public class FairyDragonStageThree : BaseEvoStage
	{
		public FairyDragonStageThree()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 300000; EpMinDivisor = 30; EpMaxDivisor = 20; DustMultiplier = 20;
			BaseSoundID = 0x1A6;
			BodyValue = 0x27; VirtualArmor = 50;
            ControlSlots = 2;
	...
	public class FairyDragonStageFour : BaseEvoStage
	{
		public FairyDragonStageFour()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 6000000; EpMinDivisor = 50; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 0;
			BodyValue = 733; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
	...
	public class FairyDragonStageFive : BaseEvoStage
	{
		public FairyDragonStageFive()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 1000000; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 1642;
			BodyValue = 95; VirtualArmor = 70;
            ControlSlots = 3;
	...
	public class FairyDragonStageSix : BaseEvoStage
	{
		public FairyDragonStageSix()
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 15000000; EpMinDivisor = 540; EpMaxDivisor = 480; DustMultiplier = 20;
			BaseSoundID = 750;
			BodyValue = 0x5; VirtualArmor = 170;
            ControlSlots = 4;
	...
	public class FairyDragonStageSeven : BaseEvoStage
	{
		public FairyDragonStageSeven()
		{
			Title = "The Ancient Fairy Dragon";
			EvolutionMessage = "has evolved to its highest form";
			NextEpThreshold = 0; EpMinDivisor = 740; EpMaxDivisor = 660; DustMultiplier = 20;
			BaseSoundID = 362;
			BodyValue = 718; ControlSlots = 4; VirtualArmor = 270;
