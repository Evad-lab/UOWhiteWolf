...
{
	[CorpseName( "a guardian Fairy dragon corpse" )]
	public class GuardianFairyDragon : FairyDragon, IEvoGuardian
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

		[Constructable]
		public GuardianFairyDragon() : base( "A Guardian Fairy Dragon" )
		{
		}

		public GuardianFairyDragon( Serial serial ) : base( serial )
		{
		}
