...
{
	[CorpseName( "a guardian Cu Sidhe corpse" )]
	public class GuardianCuSidhe : EvoCuSidhe, IEvoGuardian
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

		[Constructable]
		public GuardianCuSidhe() : base( "A Guardian Cu Sidhe" )
		{
		}

		public GuardianCuSidhe( Serial serial ) : base( serial )
		{
		}
