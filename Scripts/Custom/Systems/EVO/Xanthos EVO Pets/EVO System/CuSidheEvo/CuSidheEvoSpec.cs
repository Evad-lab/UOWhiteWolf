...
namespace Xanthos.Evo
{
	public sealed class CuSidheEvoSpec : BaseEvoSpec
	{
		...
		CuSidheEvoSpec()
		{
			...
			m_Skills = new SkillName[5] { SkillName.Healing, SkillName.MagicResist, SkillName.Tactics, SkillName.Wrestling, SkillName.Anatomy };
			m_MinSkillValues = new int[5] { 50, 50, 50, 50, 15, };
			m_MaxSkillValues = new int[5] { 110, 100, 110, 120, 110 };
	...
	public class CuSidheStageFour : BaseEvoStage
	{
		public CuSidheStageFour()
		{
			...
			BaseSoundID = 0xE5;
			BodyValue = 34; ControlSlots = 3; MinTameSkill = 119.9; VirtualArmor = 60;
			// white wolf
	...
	public class CuSidheStageFive : BaseEvoStage
	{
		public CuSidheStageFive()
		{
			...
			BaseSoundID = 0xE5; ControlSlots = 4;
			...
			DamageMin = 15; DamageMax = 50; HitsMin= 500; HitsMax = 300;
			StrMin = 300; StrMax = 300; DexMin = 60; DexMax = 60; IntMin = 200; IntMax = 200;
		}
	}
}