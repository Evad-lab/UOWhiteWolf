...
{
	public class evolutionshield: Buckler
	{
		...
		[Constructable]
		public evolutionshield()
        {
            Name = "<BASEFONT COLOR=#2E9AFE>Shield of the Wolf";
			Hue = 1153;
        ...
        public evolutionshield(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Shield of the Wolf (" + mEvolutionPoints.ToString() + ")";
        ...
        public override bool OnEquip(Mobile from)
        {
            ...
            {
                m_Owner = from;
                this.Name = m_Owner.Name.ToString() + "'s Shield of the Wolf";
                from.SendMessage("You feel the shield grow fond of you.");
            ...
            else
            {
                if (m_Owner != from)
                {
                    from.SendMessage("Sorry but this shield does not belong to you.");
                    return false;
                }
