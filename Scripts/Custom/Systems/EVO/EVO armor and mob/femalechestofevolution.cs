...
namespace Server.Items
{
	public class femalechestofevolution: LeatherBustierArms
	{
        ...
        {
            Name = "<BASEFONT COLOR=#2E9AFE>Female Chest of the Wolf";
			Hue = 1153;
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Female Chest of the Wolf (" + mEvolutionPoints.ToString() + ")";
        ...
        public override bool OnEquip(Mobile from)
        {
            ...
            {
                m_Owner = from;
                this.Name = m_Owner.Name.ToString() + "'s Female Chest of the Wolf";
