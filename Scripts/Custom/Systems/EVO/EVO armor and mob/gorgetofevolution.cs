...
namespace Server.Items
{
	public class gorgetofevolution: PlateGorget
	{
        ...
        {
            Name = "<BASEFONT COLOR=#2E9AFE>Plate Gorget of the Wolf";
			Hue = 1153;
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Plate Gorget of the Wolf (" + mEvolutionPoints.ToString() + ")";
        ...
        public override bool OnEquip(Mobile from)
        {
            ...
            {
                m_Owner = from;
                this.Name = m_Owner.Name.ToString() + "'s Plate Gorget of the Wolf";
