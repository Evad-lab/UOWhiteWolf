...
namespace Server.Items
{
	public class chestofevolution: PlateChest
	{
        ...
        {
            Name = "<BASEFONT COLOR=#2E9AFE>Plae Chest of the Wolf";
			Hue = 1153;
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Plate Chest of the Wolf(" + mEvolutionPoints.ToString() + ")";
        ...
        public override bool OnEquip(Mobile from)
        {
            ...
            {
                m_Owner = from;
                this.Name = m_Owner.Name.ToString() + "'s Plate Chest of the Wolf";
