...
namespace Server.Items
{
	public class legsofevolution: PlateLegs
	{
        ...
        {
            Name = "<BASEFONT COLOR=#2E9AFE>Plate Legs of the Wolf";
			Hue = 1153;
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Plate Legs of the Wolf (" + mEvolutionPoints.ToString() + ")";
        ...
        public override bool OnEquip(Mobile from)
        {
            ...
            {
                m_Owner = from;
                this.Name = m_Owner.Name.ToString() + "'s Plate Legs of the Wolf";
