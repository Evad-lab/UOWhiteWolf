...
namespace Server.Items
{
	public class glovesofevolution: PlateGloves
	{
        ...
        {
            Name = "<BASEFONT COLOR=#2E9AFE>Plate Gloves of the Wolf";
			Hue = 1153;
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Plate Gloves of the Wolf (" + mEvolutionPoints.ToString() + ")";
        ...
        public override bool OnEquip(Mobile from)
        {
            ...
            {
                m_Owner = from;
                this.Name = m_Owner.Name.ToString() + "'s Gloves of the Wolf";
