	...
	public class PSKey : BaseStoreKey
	{
		...
		public override List<StoreEntry> EntryStructure
		{
			get
			{
				...
				entry.Add( new ListEntry( typeof( ScrollOfTranscendence ), typeof( ScrollOfTranscendenceListEntry ), "Scrolls of Transc." ) );
				entry.Add( new ListEntry( typeof( StatCapScroll ), typeof( StatCapScrollListEntry ), "Unused" ) );
				
				//entry.Add( new StashEntry(typeof( StatCapScroll ), "Stat Scrolls", 500, new StashSortData() ) );
				return entry;
			}
		}
