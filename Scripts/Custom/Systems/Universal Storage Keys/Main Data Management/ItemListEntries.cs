...
namespace Solaris.ItemStore
{
	...
	public class ItemListEntry : IComparable
	{
		...
		public GemType GemType{ get{ return _GemType; } }
		...
		public ItemListEntry( Item item, string name, int hue )
		{
			...
			if (item is BaseJewel)
                _GemType = ((BaseJewel)item).GemType;
			else
		...
		public virtual Item GenerateItem()
		{
			...
			if (item is BaseJewel)
                ((BaseJewel)item).GemType = _GemType;
	...
	{
		public override int GumpWidth{ get{ return 850; } }
	...
	{
		public override int GumpWidth{ get{ return 600; } }
		...
		public override List<ItemListEntryColumn> Columns
		{
			get
			{
				if( _Columns == null )
				{
					...
					_Columns.Add( new ItemListEntryColumn( 450, "Value", _Value.ToString() ) );
	...
	public class StatCapScrollListEntry : ItemListEntry 
	{
		...
		{
			//this allows for inherited classes of addon deeds to fit into this entry.
			StatCapScroll scroll = (StatCapScroll)Activator.CreateInstance( typeof(StatCapScroll), new object[]{ (int)_Value } );
	...
	//stores runic tools
	public class RunicHammerListEntry : ItemListEntry 
	{
		public override int GumpWidth{ get{ return 700; } }
		...
		public override List<ItemListEntryColumn> Columns
		{
			get
			{
				if( _Columns == null )
				{
					...
					_Columns.Add( new ItemListEntryColumn( 200, "Resource", _Resource.ToString() ) );
					_Columns.Add( new ItemListEntryColumn( 400, "Uses", _UsesRemaining.ToString() ) );
		...
		//master constructor
		public RunicHammerListEntry( Item item ) : base ( item, "Runic Hammer", item.Hue - 1 )
		{						
			if ( item != null )
			{
				RunicHammer runicHammer = (RunicHammer)item;	
				_Resource = runicHammer.Resource;
				_UsesRemaining = runicHammer.UsesRemaining;
			}	
		}
		
		//world load constructor
		public RunicHammerListEntry( GenericReader reader ) : base( reader )
		{
		}
		
		//clone constructor
		public RunicHammerListEntry( RunicHammerListEntry entry ) : base( entry )
		{
		...
		public override Item GenerateItem()
		{
			//this allows for inherited classes to fit into this entry.
			RunicHammer runicHammer = (RunicHammer)Activator.CreateInstance( typeof(RunicHammer), new object[]{ _Resource, _UsesRemaining } );
			return runicHammer;					
		}
		...
		public override ItemListEntry Clone()
		{
			return new RunicHammerListEntry( this );
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( (int)_UsesRemaining );				
		}
	...
	public class RunicSewingKitListEntry : ItemListEntry 
	{
		public override int GumpWidth{ get{ return 700; } }
		...
		//master constructor
		public RunicSewingKitListEntry( Item item ) : base ( item, "Runic Sewing Kit", item.Hue - 1 )
		{						
			if ( item != null )
			{
				RunicSewingKit runicSewingKit = (RunicSewingKit)item;	
				_Resource = runicSewingKit.Resource;
				_UsesRemaining = runicSewingKit.UsesRemaining;				
			}	
		}
		
		//world load constructor
		public RunicSewingKitListEntry( GenericReader reader ) : base( reader )
		{
		}
		
		//clone constructor
		public RunicSewingKitListEntry( RunicSewingKitListEntry entry ) : base( entry )
		{
			_Resource = entry.Resource;
			_UsesRemaining = entry.UsesRemaining;
		}
		...
		{
			//this allows for inherited classes to fit into this entry.
			RunicSewingKit runicSewingKit = (RunicSewingKit)Activator.CreateInstance( typeof(RunicSewingKit), new object[]{ _Resource, _UsesRemaining } );
			return runicSewingKit;					
		}
		...
		public override ItemListEntry Clone()
		{
			return new RunicSewingKitListEntry( this );
	...
	public class RunicFletcherToolListEntry : ItemListEntry 
	{
		public override int GumpWidth{ get{ return 700; } }
		...
		//master constructor
		public RunicFletcherToolListEntry( Item item ) : base ( item, "Runic Fletcher Tool", item.Hue - 1 )
		{						
			if ( item != null )
			{
				RunicFletcherTool runicFletcherTool = (RunicFletcherTool)item;	
				_Resource = runicFletcherTool.Resource;
				_UsesRemaining = runicFletcherTool.UsesRemaining;				
			}	
		}
		
		//world load constructor
		public RunicFletcherToolListEntry( GenericReader reader ) : base( reader )
		{
		}
		
		//clone constructor
		public RunicFletcherToolListEntry( RunicFletcherToolListEntry entry ) : base( entry )
		{
			_Resource = entry.Resource;
			_UsesRemaining = entry.UsesRemaining;			
		}
		...
		{
			//this allows for inherited classes to fit into this entry.
			RunicFletcherTool runicFletcherTool = (RunicFletcherTool)Activator.CreateInstance( typeof(RunicFletcherTool), new object[]{ _Resource, _UsesRemaining } );
			return runicFletcherTool;					
		}
		...
		public override ItemListEntry Clone()
		{
			return new RunicFletcherToolListEntry( this );
	...
	public class RunicDovetailSawListEntry : ItemListEntry 
	{
		public override int GumpWidth{ get{ return 700; } }
		...
		//master constructor
		public RunicDovetailSawListEntry( Item item ) : base ( item, "Runic Dovetail Saw", item.Hue - 1 )
		{						
			if ( item != null )
			{
				RunicDovetailSaw runicDovetailSaw = (RunicDovetailSaw)item;	
				_Resource = runicDovetailSaw.Resource;
				_UsesRemaining = runicDovetailSaw.UsesRemaining;					
			}	
		}
		
		//world load constructor
		public RunicDovetailSawListEntry( GenericReader reader ) : base( reader )
		{
		}
		
		//clone constructor
		public RunicDovetailSawListEntry( RunicDovetailSawListEntry entry ) : base( entry )
		{
			_Resource = entry.Resource;
			_UsesRemaining = entry.UsesRemaining;			
		}
		...
		{
			//this allows for inherited classes to fit into this entry.
			RunicDovetailSaw runicDovetailSaw = (RunicDovetailSaw)Activator.CreateInstance( typeof(RunicDovetailSaw), new object[]{ _Resource, _UsesRemaining } );
			return runicDovetailSaw;					
		}
		...
		public override ItemListEntry Clone()
		{
			return new RunicDovetailSawListEntry( this );
	...
	public class RunicMalletAndChiselListEntry : ItemListEntry 
	{
		public override int GumpWidth{ get{ return 700; } }
		...
		//master constructor
		public RunicMalletAndChiselListEntry( Item item ) : base ( item, "Runic Mallet and Chisel", item.Hue - 1 )
		{						
			if ( item != null )
			{
				RunicMalletAndChisel runicMalletAndChisel = (RunicMalletAndChisel)item;	
				_Resource = runicMalletAndChisel.Resource;
				_UsesRemaining = runicMalletAndChisel.UsesRemaining;				
			}	
		}
		
		//world load constructor
		public RunicMalletAndChiselListEntry( GenericReader reader ) : base( reader )
		{
		}
		
		//clone constructor
		public RunicMalletAndChiselListEntry( RunicMalletAndChiselListEntry entry ) : base( entry )
		{
			_Resource = entry.Resource;
			_UsesRemaining = entry.UsesRemaining;			
		}
		...
		{
			//this allows for inherited classes to fit into this entry.
			RunicMalletAndChisel runicMalletAndChisel = (RunicMalletAndChisel)Activator.CreateInstance( typeof(RunicMalletAndChisel), new object[]{ _Resource, _UsesRemaining } );
			return runicMalletAndChisel;					
		}
		...
		public override bool AllGood( Item item )
		{
			...
			//TODO: move this to base class, since the _Type is specified in ListEntry?
			if( !( item is RunicMalletAndChisel ) )
			{
				return false;
			}
		...
		public override ItemListEntry Clone()
		{
			return new RunicMalletAndChiselListEntry( this );
	...
	public class RunicTinkerToolsListEntry : ItemListEntry 
	{
		public override int GumpWidth{ get{ return 700; } }
		...
		//master constructor
		public RunicTinkerToolsListEntry( Item item ) : base( item, "Runic Tinker Tools" )
		{						
			if ( item != null )
			{
				RunicTinkerTools runicTinkerTools = (RunicTinkerTools)item;	
				_Resource = runicTinkerTools.Resource;
				_UsesRemaining = runicTinkerTools.UsesRemaining;				
			}	
		}
		
		//world load constructor
		public RunicTinkerToolsListEntry( GenericReader reader ) : base( reader )
		{
		}
		
		//clone constructor
		public RunicTinkerToolsListEntry( RunicTinkerToolsListEntry entry ) : base( entry )
		{
			_Resource = entry.Resource;
			_UsesRemaining = entry.UsesRemaining;			
		}
		...
		{
			//this allows for inherited classes to fit into this entry.
			RunicTinkerTools runicTinkerTools = (RunicTinkerTools)Activator.CreateInstance( typeof(RunicTinkerTools), new object[]{ _Resource, _UsesRemaining } );
			return runicTinkerTools;					
		}
		...
		public override ItemListEntry Clone()
		{
			return new RunicTinkerToolsListEntry( this );
