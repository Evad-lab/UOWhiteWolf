...
namespace Solaris.ItemStore
{
	...
	public class ItemStore : IDisposable
	{
		...
		public void AddItem( Mobile from, object targeted )
		{
			...
			//Handle runic fletcher tools insertion

			if( item is RunicFletcherTools )
			{
				int uses = ((RunicFletcherTools)item).UsesRemaining;
				
				switch (((RunicFletcherTools)item).Resource)
				{
					case CraftResource.OakWood:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.OakWood, uses);
						break;
					case CraftResource.AshWood:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.AshWood, uses);
						break;
					case CraftResource.YewWood:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.YewWood, uses);
						break;
					case CraftResource.Heartwood:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.Heartwood, uses);
						break;
					case CraftResource.Bloodwood:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.Bloodwood, uses);
						break;
					case CraftResource.Frostwood:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.Frostwood, uses);
						break;
					case CraftResource.Ebony:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.Ebony, uses);
						break;
					case CraftResource.Bamboo:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.Bamboo, uses);
						break;
					case CraftResource.PurpleHeart:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.PurpleHeart, uses);
						break;
					case CraftResource.Redwood:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.Redwood, uses);
						break;
					case CraftResource.Petrified:
						item.Delete();
						item = new RunicFletcherTool(CraftResource.Petrified, uses);
						break;	
				}
			}
