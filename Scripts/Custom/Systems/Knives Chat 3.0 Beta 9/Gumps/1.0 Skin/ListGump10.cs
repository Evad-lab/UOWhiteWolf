...
namespace Knives.Chat3
{
    public class ListGump10 : GumpPlus
    {
        ...
        private void BuildTabs(int width, int y)
        {
            ...
            AddHtml(width / 2 - 90, y + 3, 60, (c_ListPage == ListPage.Channel ? HTML.Green : HTML.White) + "<CENTER>" + (Data.GetData(Current).CurrentChannel == null ? "" : Data.GetData(Current).CurrentChannel.NameFor(Current)) );
