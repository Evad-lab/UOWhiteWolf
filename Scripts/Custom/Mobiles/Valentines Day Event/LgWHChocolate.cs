...
{
    [CorpseName("a large puddle of melted chocolate")]
    public class LgWHChocolate : BaseCreature
    {
        [Constructable]
        public LgWHChocolate()
            : base(AIType.AI_Spellweaving, FightMode.Closest, 10, 1, 0.6, 1.2)
        {
            this.Name = "a large piece of white chocolate";
            this.Body = 780;
			this.Hue = 2035;
        ...
        public LgWHChocolate(Serial serial)
            : base(serial)
        {
        }
