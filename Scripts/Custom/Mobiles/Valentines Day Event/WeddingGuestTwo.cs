...
{
    [CorpseName("Must hold the floor in place.")]
    public class WeddingGuestTwo : BaseCreature
    {
            ...
            : base(AIType.AI_Spellweaving, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            SetResistance(ResistanceType.Physical, 21, 50);
            SetResistance(ResistanceType.Fire, 20, 30);
            SetResistance(ResistanceType.Cold, 20, 39);
            SetResistance(ResistanceType.Poison, 20, 30);
            SetResistance(ResistanceType.Energy, 23, 30);
        ...
        public WeddingGuestTwo(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (reader.ReadBool())
                ValidationQueue<WeddingGuestTwo>.Add(this);
        }
