...
{
    public class BatCanFixIt : BaseSeaChampion
    {
        ...
        public BatCanFixIt(CorgulAltar altar)
        ...
        {
            private BatCanFixIt m_Mobile;
            private int m_Tick;

            public InternalTimer(BatCanFixIt mob, int range)
        ...
        public BatCanFixIt(Serial serial)
            : base(serial)
        {
        }
