...
{
    public class WWTwistedTwinBrother : BaseCreature
    {
        [Constructable]
        public WWTwistedTwinBrother()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "White Wolf's Twisted Twin Brother";
            Title = "Healer of the Poisoned";
			Hue = 2412;
        ...
        public WWTwistedTwinBrother(Serial serial)
            : base(serial)
        {
        }
