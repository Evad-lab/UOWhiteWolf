...
{
    public class TheDemonDevil : BaseSeaChampion
    {
        ...
        [Constructable]
        public TheDemonDevil()
            : this(null)
        {
        }

        public TheDemonDevil(CorgulAltar altar)
            : base(null, AIType.AI_NecroMage, FightMode.Closest)
        {
            m_Altar = altar;
            Name = "The Daemon Devil";
			Title = "Spectral of the Underworld";
            BaseSoundID = 0;
            BodyValue = 1433;
            Hue = 0;
        ...
        {
            private TheDemonDevil m_Mobile;
            private int m_Tick;

            public InternalTimer(TheDemonDevil mob, int range)
        ...
        public TheDemonDevil(Serial serial)
            : base(serial)
        {
        }
