...
{
    public class WWDreadTwinBrother : BaseCreature
    {
		
		// Serado
        [Constructable]
        public WWDreadTwinBrother()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "White Wolf's Dread Twin Brother";
            Title = "Keeper of the Poisoned";
			Hue = 2412;
        ...
        public WWDreadTwinBrother(Serial serial)
            : base(serial)
        {
        }
