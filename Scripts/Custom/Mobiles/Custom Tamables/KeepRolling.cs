...
{
	[CorpseName( "a corpse of keep rolling" )]
	public class KeepRolling: BaseCreature
	{

		[Constructable]
		public KeepRolling() : this( "Keep Rolling" )
		{
		}

		[Constructable]
		public KeepRolling( string name ) : base( AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public KeepRolling( Serial serial ) : base( serial )
		{
		}
