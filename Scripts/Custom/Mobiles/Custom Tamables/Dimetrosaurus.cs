...
{
	[CorpseName( "a corpse of a Dimetrosaurus" )]
	public class Dimetrosaurus: BaseCreature
	{

		[Constructable]
		public Dimetrosaurus() : this( "Dimetrosaurus" )
		{
		}

		[Constructable]
		public Dimetrosaurus( string name ) : base( AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public Dimetrosaurus( Serial serial ) : base( serial )
		{
		}
