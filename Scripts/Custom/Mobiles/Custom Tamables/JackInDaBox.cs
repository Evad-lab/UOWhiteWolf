...
{
	[CorpseName( "a corpse of a jack in da box" )]
	public class JackInDaBox : BaseCreature
	{

		[Constructable]
		public JackInDaBox() : this( "a Jack In Da Box" )
		{
		}
		...
		public JackInDaBox( Serial serial ) : base( serial )
		{
		}
