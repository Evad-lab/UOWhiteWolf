...
{
	[CorpseName( "a corpse of a triceratops" )]
	public class Triceratop: BaseCreature
	{

		[Constructable]
		public Triceratop() : this( "a Triceratops" )
		{
		}

		[Constructable]
		public Triceratop( string name ) : base( AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public Triceratop( Serial serial ) : base( serial )
		{
		}
