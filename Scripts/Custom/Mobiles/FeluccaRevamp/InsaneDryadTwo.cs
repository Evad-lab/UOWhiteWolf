...
namespace Server.Mobiles
{
    ...
    public class MLDryadTwo : BaseCreature
    {
        ...
        public MLDryadTwo(Serial serial)
            : base(serial)
        {
        }
    ...
    public class InsaneDryadTwo : MLDryadTwo
    {
        public override bool InitialInnocent
        {
            get
        ...
        public InsaneDryadTwo(Serial serial)
            : base(serial)
        {
        }
