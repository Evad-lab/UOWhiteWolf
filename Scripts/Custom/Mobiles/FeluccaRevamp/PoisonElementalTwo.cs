...
namespace Server.Mobiles
{
    ...
    public class PoisonElementalTwo : BaseCreature
    {
        [Constructable]
        public PoisonElementalTwo()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetHits(3256, 3309);

            this.SetDamage(22, 28);
        ...
        public PoisonElementalTwo(Serial serial)
            : base(serial)
        {
        }
