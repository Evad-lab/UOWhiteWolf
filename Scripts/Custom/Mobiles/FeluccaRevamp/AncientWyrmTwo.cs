...
namespace Server.Mobiles
{
    ...
    public class AncientWyrmTwo : BaseCreature
    {
        [Constructable]
        public AncientWyrmTwo()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetStr(1296, 1285);
            this.SetDex(86, 175);
            this.SetInt(686, 775);

            this.SetHits(7658, 7711);

            this.SetDamage(35, 49);
        ...
        public AncientWyrmTwo(Serial serial)
            : base(serial)
        {
        }
