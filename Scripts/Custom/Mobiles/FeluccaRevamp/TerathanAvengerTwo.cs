...
namespace Server.Mobiles
{
    ...
    public class TerathanAvengerTwo : BaseCreature
    {
        [Constructable]
        public TerathanAvengerTwo()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetHits(1296, 1372);
            this.SetMana(46, 70);

            this.SetDamage(28, 32);
        ...
        public TerathanAvengerTwo(Serial serial)
            : base(serial)
        {
        }
