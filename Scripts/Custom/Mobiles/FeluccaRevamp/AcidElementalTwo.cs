...
{
    public interface IAcidCreatureTwo
    {
    }

    [CorpseName("an acid elementals corpse")]
    public class AcidElementalTwo : BaseCreature, IAcidCreature
    {
        [Constructable]
        public AcidElementalTwo()
        ...
        public AcidElementalTwo(Serial serial)
            : base(serial)
        {
        }
