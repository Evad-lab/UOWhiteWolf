...
{ 
	...
	public class KrampusTwo : BaseCreature 
	{ 
		...
		[Constructable] 
		public KrampusTwo() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{ 
			Name = "Krampus";
			Title = ( "Companion of Santa Claus" );
			BodyValue = 271;
			Hue = 0;  
		...
		public override void OnGotMeleeAttack( Mobile attacker )
		{
			...
			if ( m_FieldActive )
			{
				...
				attacker.SendAsciiMessage( "You've been Naughty!" );
			}
		...
		public void DrainLife()
		{
			...
			foreach ( Mobile m in list )
			{
				...
				m.SendMessage( "You feel your life force being pulled from your body!" );
		...
		public KrampusTwo( Serial serial ) : base( serial )
		{
		}
