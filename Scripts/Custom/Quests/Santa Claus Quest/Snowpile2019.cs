...
{ 
   ...
   public class Snowpile2019 : Item 
   { 
      [Constructable] 
      public Snowpile2019() : base( 0x913 ) 
      { 
         Hue = 1151; 
      	Name="Snowball Launcher 2019";
      	LootType = LootType.Blessed;
	    m_NextAbilityTime = DateTime.UtcNow;
   
      } 

      public Snowpile2019( Serial serial ) : base( serial ) 
      { 
      } 
private DateTime m_NextAbilityTime;
      ...
      { 
		...
		private Snowpile2019 m_Snow;

         public SnowTarget( Mobile thrower, Snowpile2019 snow ) : base ( 10, false, TargetFlags.None ) 
         { 
         	m_Thrower = thrower;
			m_Snow=snow;
         } 
