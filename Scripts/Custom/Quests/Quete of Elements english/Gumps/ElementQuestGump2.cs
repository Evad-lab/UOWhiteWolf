    ...
    public class ElementQuestGump2 : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddHtml(107, 140, 300, 230, "<BODY>" +
                //----------------------/----------------------------------------------/
"<BASEFONT COLOR=YELLOW>What?! You succeeded! I knew you could do it!<BR><BR>" +
"<BASEFONT COLOR=YELLOW>Don't stop now!<BR><BR>" +
"<BASEFONT COLOR=YELLOW>So Here is second riddle.<BR><BR>" +
"<BASEFONT COLOR=WHITE>As soon as one names me I don't exist any more.<BR><BR>" +
"<BASEFONT COLOR=WHITE><I>Who am I?</I><BR><BR>" +
"<BASEFONT COLOR=YELLOW>You'll find Eole in the city of Wind, give him the answer and return me the Element of Air.<BR><BR>" +
