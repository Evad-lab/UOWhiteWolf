...
//----------------------/----------------------------------------------/
"<BASEFONT COLOR=WHITE>Lord Santa walks over to you *As you hear rumbling* He says I have a favor to ask of you...<BR><BR>So you like snow I see. Well what if I told you that someone was peeing in my snow? Santa, as sad as thats sounds it's true.<BR>" +
"<BASEFONT COLOR=WHITE>So will you help me?<BR><BR>will you help me? You must beat up the Bad Elves that are peeing in my snow." +
"<BASEFONT COLOR=WHITE>What I require of you is to beat up these Bad Elves and make them stop, then bring me back 10 yellow snows as proof.<BR><BR>They are not easy cause they like to hide and sneak around but ill tell you what beat them up and bring back what I asked you too and then ill make the the best gifts that a Santa can make." +
						     "</BODY>", false, true);
...
//			AddLabel( 113, 165, 0x34, "well some Bad Elves are peeing in my snow." );
...
//			AddLabel( 113, 235, 0x34, "They are hard little bastards cause " );
//			AddLabel( 113, 250, 0x34, "they are all over the place" );
//			AddLabel( 113, 265, 0x34, "beat them up and bring me back the snow" );
//			AddLabel( 113, 280, 0x34, "and I'll make you the best items that a Santa" );
