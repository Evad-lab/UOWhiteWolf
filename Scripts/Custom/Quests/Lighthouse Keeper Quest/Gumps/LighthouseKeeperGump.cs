...
"<BASEFONT COLOR=White>There is a creature that carries these crystals. It is thought that it wanders near the lighthouse, in the far north of the Lost Lands.<br><br>" +
"<BASEFONT COLOR=White>If you can bring me a light enhancing crystal, I will reward you with a Travel Book.<br><br>" +
"<BASEFONT COLOR=White>This is not just an ordinary Travel Book. I have been able to alter the Light Enhancing Crystals to work within the pages to provide a way of travel. Though I have yet to find a way to make the amount of uses indefinite.<br><br>" +
