...
"<BASEFONT COLOR=YELLOW>I see you have an interest in the Arcane Arts?<BR>" +
"<BASEFONT COLOR=YELLOW>Are you wanting to know a bit more of the forbidden magics of nature itself?<BR>" +
"<BASEFONT COLOR=YELLOW>Do you not care the cost or the dangers in your quest for greater knowledge?<BR>" +
...
"<BASEFONT COLOR=YELLOW>Well anyways there was this evil Centaur. Rude bugger truly. This centaur guards the last places I could harvest Amanita Muscaria.<BR>" +
"<BASEFONT COLOR=YELLOW>It is a very rare mushroom left over from the first cataclysm, but that is another matter.<BR>" +
"<BASEFONT COLOR=YELLOW>Go North of the Shrine of Sacrifice and look under the trees there. If you find no Amanita Muscaria growing then Equestrius has already picked it all.<BR>" +
"<BASEFONT COLOR=YELLOW>Slay him and surely he will have some of this rare fungi on his corpse. Return some Muscaria to me and I will reward you in kind.<BR>" +
"</BODY>", false, true);
//----------------------/----------------------------------------------/
