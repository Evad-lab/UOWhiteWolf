...
Blessed = true;
CantWalk = true;
AddItem( new Robe( 193 ) );
AddItem( new Sandals( 193 ) );
...
// thanks message
this.PrivateOverheadMessage( MessageType.Regular, 1153, false, "My gracious thanks. Now I can combine these to craft more books. Enjoy your reward!", mobile.NetState );
