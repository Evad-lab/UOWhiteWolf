...
namespace Server.Items
{
	...
	public class SleeperBlueCanopyAddon: BaseAddon, IChopable
	{
      ...
      public override BaseAddonDeed Deed
        {
            get
            {
                return new SleeperBlueCanopyAddonDeed ();
            }
        }

		public SleeperBlueCanopyAddon( Serial serial ) : base( serial )
		{
		}

		[Constructable]
		public SleeperBlueCanopyAddon( ) 
		{
			Visible = true;
			Name = "Canopy Sleeper";
			AddComponent( new SleeperBlueCanopyPiece(this, 2682), -1, 1, 0 );
			Hue = 88;
			AddComponent( new SleeperBlueCanopyPiece(this, 2683), -1, 0, 0 );
			Hue = 88;
			AddComponent( new SleeperBlueCanopyPiece(this, 2681), 0, 0, 0 );
			Hue = 88;
			AddComponent( new SleeperBlueCanopyPiece(this, 2680), 0, 1, 0 );
			Hue = 88;
						AddonComponent ac;
		...
		private SleeperBlueCanopyAddon m_Sleeper;
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public SleeperBlueCanopyAddon Sleeper
		{
	...
	public class SleeperBlueCanopyPiece : AddonComponent
	{

		private SleeperBlueCanopyAddon m_Sleeper;

		public SleeperBlueCanopyPiece( SleeperBlueCanopyAddon sleeper, int itemid ) : base( itemid )
		{
			m_Sleeper = sleeper;
		}
		...
		public SleeperBlueCanopyPiece( Serial serial ) : base( serial )
		{
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			base.Deserialize( reader );
			int version = reader.ReadInt();
			m_Sleeper = (SleeperBlueCanopyAddon)reader.ReadItem();

		}

	}
   public class SleeperBlueCanopyAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new SleeperBlueCanopyAddon ();
            }
        }

        [Constructable]
        public SleeperBlueCanopyAddonDeed ()
        {
            Name = "a blue canopy sleeper facing east deed.";
        }

        public SleeperBlueCanopyAddonDeed ( Serial serial )
            : base ( serial )
        {
        }
