...
namespace Server.Items
{
    ...
    public class FemalePlateTunicCrimsonDoom : BaseArmor
    {
        [Constructable]
        public FemalePlateTunicCrimsonDoom()
            : base(0x1C04)
        {
            Weight = 10.0;
			Name = "Female Plate Tunic of Crimson Doom";
        ...
        public FemalePlateTunicCrimsonDoom(Serial serial)
            : base(serial)
        {
        }
