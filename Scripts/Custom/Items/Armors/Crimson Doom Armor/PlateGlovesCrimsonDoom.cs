...
namespace Server.Items
{
    ...
    public class PlateGlovesCrimsonDoom : BaseArmor
    {
        [Constructable]
        public PlateGlovesCrimsonDoom()
            : base(0x1414)
        {
            Weight = 2.0;
			Name = "Plate Gloves of Crimson Doom";
        ...
        public PlateGlovesCrimsonDoom(Serial serial)
            : base(serial)
        {
        }
