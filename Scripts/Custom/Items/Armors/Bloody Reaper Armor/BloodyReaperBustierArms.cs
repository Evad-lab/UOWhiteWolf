...
namespace Server.Items
{
    ...
    public class BloodyReaperBustierArms : BaseArmor
    {
        [Constructable]
        public BloodyReaperBustierArms()
            : base(0x1C0A)
        {
            this.Weight = 1.0;
			Name = "Bustier of the Bloody Reaper";
        ...
        public BloodyReaperBustierArms(Serial serial)
            : base(serial)
        {
        }
