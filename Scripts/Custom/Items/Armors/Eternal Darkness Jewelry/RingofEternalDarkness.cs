...
{
	public class RingofEternalDarkness : GoldRing
	{


		[Constructable]
		public RingofEternalDarkness()
		{
			Name = "Ring Of Eternal Darkness";
			Hue = 2498;
		...
		public RingofEternalDarkness( Serial serial ) : base( serial )
		{
		}
