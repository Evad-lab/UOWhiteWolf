...
{
	public class BraceletofEternalDarkness : GoldBracelet
	{


		[Constructable]
		public BraceletofEternalDarkness()
		{
			Name = "Bracelet Of Eternal Darkness";
			Hue = 2498;
		...
		public BraceletofEternalDarkness( Serial serial ) : base( serial )
		{
		}
