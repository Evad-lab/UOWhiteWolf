...
namespace Server.Engines.Craft
{
    ...
    public class DefBowFletching : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
			...
			AddSubRes(typeof(EbonyBoard), "Ebony", 80.0, 1072652);
			AddSubRes(typeof(BambooBoard), "Bamboo", 90.0, 1072652);
			AddSubRes(typeof(PurpleHeartBoard), "PurpleHeart", 100.0,  1072652);
			AddSubRes(typeof(RedwoodBoard), "Redwood", 110.0, 1072652);
			AddSubRes(typeof(PetrifiedBoard), "Petrified", 119.0, 1072652);			
			
            //daat99.ResourceHelper.AddWoodResources(this);
			//daat99 OWLTR start - custom wood
			//
			//removed for daat99 OWLTR
			//
			/*
