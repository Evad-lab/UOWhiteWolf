    ...
    public class DefBlacksmithy : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            */
			...
			AddSkill(index, SkillName.Tailoring, 120.0, 120.0);
			AddSkill(index, SkillName.Fletching, 120.0, 120.0);
			...
			//daat99 OWLTR start - custom metal
			//
