...
namespace Server.Engines.Harvest
{
    public class Lumberjacking : HarvestSystem
    {
        ...
        private Lumberjacking()
        {
			...
			{
				new HarvestVein( 27.0, 0.0, res[0],  null   ), // this line should replace the original line
				new HarvestVein( 12.0, 0.5, res[1],  res[0] ), 	// OakLog
				new HarvestVein( 11.0, 0.5, res[2],  res[0] ), 	// AshLog
				new HarvestVein( 10.0, 0.5, res[3],  res[0] ), 	// YewLog 
				new HarvestVein( 05.0, 0.5, res[4],  res[0] ), 	// HeartwoodLog
				new HarvestVein( 05.0, 0.5, res[5],  res[0] ), 	// BloodwoodLog
				new HarvestVein( 05.0, 0.5, res[6],  res[0] ), 	// FrostwoodLog 
				new HarvestVein( 05.0, 0.5, res[7],  res[0] ), 	// EbonyLog
				new HarvestVein( 05.0, 0.5, res[8],  res[0] ), 	// BambooLog
				new HarvestVein( 05.0, 0.5, res[9],  res[0] ), 	// PurpleHeartLog
				new HarvestVein( 05.0, 0.5, res[10], res[0] ),	// RedwoodLog
				new HarvestVein( 05.0, 0.5, res[11], res[0] ),	// PetrifiedLog
			};
