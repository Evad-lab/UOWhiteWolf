        ...
        public bool CheckFilter(BulkMaterialType mat, int amountMax, bool isLarge, bool reqExc, BODType deedType, Type itemType)
        {
            ...
            if (BulkOrderSystem.NewSystemEnabled)
            {
                switch (f.Material)
                {
					...
					//daat99 OWLTR - start
					case 18: return (mat == BulkMaterialType.Blaze && deedType == BODType.Smith);
					case 19: return (mat == BulkMaterialType.Ice && deedType == BODType.Smith);
					case 20: return (mat == BulkMaterialType.Toxic && deedType == BODType.Smith);
					case 21: return (mat == BulkMaterialType.Electrum && deedType == BODType.Smith);
					case 22: return (mat == BulkMaterialType.Platinum && deedType == BODType.Smith);
					//daat99 OWLTR - end
					...
					//daat99 OWLTR - start
					case 28: return (mat == BulkMaterialType.Polar && BGTClassifier.Classify(deedType, itemType) == BulkGenericType.Leather);
					case 29: return (mat == BulkMaterialType.Synthetic && BGTClassifier.Classify(deedType, itemType) == BulkGenericType.Leather);
					case 30: return (mat == BulkMaterialType.BlazeL && BGTClassifier.Classify(deedType, itemType) == BulkGenericType.Leather);
					case 31: return (mat == BulkMaterialType.Daemonic && BGTClassifier.Classify(deedType, itemType) == BulkGenericType.Leather);
					case 32: return (mat == BulkMaterialType.Shadow && BGTClassifier.Classify(deedType, itemType) == BulkGenericType.Leather);
					case 33: return (mat == BulkMaterialType.Frost && BGTClassifier.Classify(deedType, itemType) == BulkGenericType.Leather);
					case 34: return (mat == BulkMaterialType.Ethereal && BGTClassifier.Classify(deedType, itemType) == BulkGenericType.Leather);
					//daat99 OWLTR - end
					...
					//daat99 OWLTR - start
					case 44: return (mat == BulkMaterialType.Blaze && deedType == BODType.Tinkering);
					case 45: return (mat == BulkMaterialType.Ice && deedType == BODType.Tinkering);
					case 46: return (mat == BulkMaterialType.Toxic && deedType == BODType.Tinkering);
					case 47: return (mat == BulkMaterialType.Electrum && deedType == BODType.Tinkering);
					case 48: return (mat == BulkMaterialType.Platinum && deedType == BODType.Tinkering);
					//daat99 OWLTR - end
					...
					//daat99 OWLTR - start
					case 56: return (mat == BulkMaterialType.Ebony && deedType == BODType.Carpentry);
					case 57: return (mat == BulkMaterialType.Bamboo && deedType == BODType.Carpentry);
					case 58: return (mat == BulkMaterialType.PurpleHeart && deedType == BODType.Carpentry);
					case 59: return (mat == BulkMaterialType.Redwood && deedType == BODType.Carpentry);
					case 60: return (mat == BulkMaterialType.Petrified && deedType == BODType.Carpentry);
					//daat99 OWLTR - start
					...
					//daat99 OWLTR - start
					case 68: return (mat == BulkMaterialType.Ebony && deedType == BODType.Fletching);
					case 69: return (mat == BulkMaterialType.Bamboo && deedType == BODType.Fletching);
					case 70: return (mat == BulkMaterialType.PurpleHeart && deedType == BODType.Fletching);
					case 71: return (mat == BulkMaterialType.Redwood && deedType == BODType.Fletching);
					case 72: return (mat == BulkMaterialType.Petrified && deedType == BODType.Fletching); 
					//daat99 OWLTR - start
                }
            }
            else
