...
namespace Server.Items
{
    public abstract class BaseArmor : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability, IResource, ISetItem, IVvVItem, IOwnerRestricted, ITalismanProtection, IEngravable, IArtifact, ICombatEquipment, IQuality
    {
        ...
        */
        ...
        public override int PhysicalResistance { get { return ((m_PhysicalResistance != -1) ? m_PhysicalResistance : (BasePhysicalResistance + GetProtOffset() + m_PhysicalBonus)); } }
        public override int FireResistance { get { return ((m_FireResistance != -1) ? m_FireResistance : (BaseFireResistance + GetProtOffset() + m_FireBonus)); } }
        public override int ColdResistance { get { return ((m_ColdResistance != -1) ? m_ColdResistance : (BaseColdResistance + GetProtOffset() + m_ColdBonus)); } }
        public override int PoisonResistance { get { return ((m_PoisonResistance != -1) ? m_PoisonResistance : (BasePoisonResistance + GetProtOffset() + m_PoisonBonus)); } }
        public override int EnergyResistance { get { return ((m_EnergyResistance != -1) ? m_EnergyResistance : (BaseEnergyResistance + GetProtOffset() + m_EnergyBonus)); } }
        //daat99 OWLTR end
		//
		//original code below commented out for OWLTR
		//
        ...
        public override void Serialize(GenericWriter writer)
        {
			...
			//daat99 OWLTR start - increase version from 8 to 9 and save resistance
            writer.Write((int)9901); // version
            //version 9901
			//
			//custom scripts changing serialization will use the range 990x
			//
            ...
            // Version 15 - not documented by ServUO devs. They added a prop in the middle of the Serialization...
			...
			// ServUO-57 Core Upgrade : Version 15
            if (GetSaveFlag(flags, SaveFlag.xWeaponAttributes))
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch ( version )
			{
				//daat99 OWLTR start - load resists version 9901
                case 9901:
                    {
